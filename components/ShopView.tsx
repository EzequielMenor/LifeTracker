...
export function ShopView({ data, onUpdate, onClose }: ShopViewProps) {
  ...
  const handleBuyGameItem = (item: any) => {
    if (spendGold(item.cost)) {
      // Logic to activate item would go here
      // For MVP just toast
      if (item.id === "shield") {
        toast.success("🛡️ ¡Escudo Activado! Tu racha está a salvo.");
      } else {
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  canAfford
                    ? "hover:border-yellow-500/50 hover:shadow-lg hover:-translate-y-1 bg-card"
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  canAfford
                    ? "bg-card hover:border-purple-500/50 hover:bg-purple-500/5"
                    : "bg-muted opacity-60 cursor-not-allowed grayscale",
                )}
              >
                <div
                  className={cn(
