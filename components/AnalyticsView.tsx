...
export function AnalyticsView({ data }: AnalyticsProps) {
  ...
  const avgConsistency =
    radarData.length > 0
      ? Math.round(
          radarData.reduce((acc, curr) => acc + curr.A, 0) / habits.length,
        )
      : 0;
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {
                Object.values(
                  data.entries?.[format(today, "yyyy-MM-dd")]?.tasks || {},
                ).filter(Boolean).length
              }
            </div>
            <p className="text-xs text-muted-foreground">
              Objetivos diarios cumplidos
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Basado en volumen de actividad
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="md:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Comparativa de Hábitos vs Tareas (últimos 7 días)
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Equilibrio entre hábitos (30 días)
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[300px] w-full">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Intensidad diaria (Hábitos + Tareas)
          </CardDescription>
        </CardHeader>
        <CardContent>
